        ...
        if (result.ok && result.messages) {
          ...
          if (!hasWarehouseReport) {
            ...
            return slackClient.chat.postMessage({
              channel: process.env.SLACK_WAREHOUSE_ALERT_CHANNEL_ID,
              text: `<@${process.env.SLACK_OWNER_USER_SAVA_ID}> <@${process.env.SLACK_OWNER_USER_GORYAINOV_ID}> Звіт Warehouse Statistics не прийшов до 12:30, перевірте, будь ласка, причину.`,
              unfurl_links: false
            });
          } else {
